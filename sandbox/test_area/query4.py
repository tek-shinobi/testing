...
SELECT
	o."ShipCountry", o."EmployeeID",
	sum(o."Freight") over(partition by o."EmployeeID") employeeid_freight,
	sum(o."Freight") over(partition by o."EmployeeID", o."ShipCountry") employeeid_freight_country
FROM
	public.orders o
ORDER BY
	o."EmployeeID", o."ShipCountry"
"""
...
query = (
    ...
    .order_by(orders.c.EmployeeID, orders.c.ShipCountry)
    .limit(20)
)
# ).order_by([orders.c.EmployeeID, orders.c.ShipCountry]).limit(20)
# query = (
#    meta.session.query(
